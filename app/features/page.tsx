...
const featureSections = [
  ...
  },
  {
    ...
    description: "Caregivers get powerful tools to tailor the experience, while keeping it safe from accidental changes.",
    icon: (
      <svg className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    <div className="py-16 space-y-20">
      ...
      <ScrollReveal>
        <div className="text-center space-y-4">
          ...
          <p className="mx-auto max-w-3xl text-lg text-slate-600 leading-relaxed">
            Loquor AAC brings together powerful communication tools and an intuitive interface
      ...
      <ScrollReveal>
        <CTABanner
          ...
          subtitle="Download the app and discover how Loquor AAC can transform communication."
