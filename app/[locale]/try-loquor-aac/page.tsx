      ...
      <ScrollReveal>
        <div className="text-center rounded-3xl bg-linear-to-br from-indigo-50 to-blue-50 border border-indigo-100 p-10 space-y-6">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <div
              aria-disabled="true"
              className="inline-flex items-center gap-3 rounded-xl bg-slate-400 px-5 py-3 text-white cursor-not-allowed select-none"
            >
            ...
            <a
              href="https://play.google.com/store/apps/details?id=com.thierrryalex.loquoraac"
              target="_blank"
