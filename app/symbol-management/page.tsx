...
const sections = [
  ...
  },
  {
    ...
    screenshotDescription: "Symbol list filtered to favourites with star and eye toggle buttons",
    items: [
  ...
  },
  {
    ...
    screenshotDescription: "Symbol editor with label, spoken text, emoji, image, and category fields",
    items: [
  ...
  },
  {
    ...
    screenshotDescription: "Editor section showing Position, Motor Zone, Word Type, and Introduction Level fields",
    items: [
  ...
  },
  {
    ...
    screenshotDescription: "Confirmation dialog showing board and favourite usage warnings",
    items: [
