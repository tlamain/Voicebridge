...
export default function AppScreenshot({
  ...
  return (
    <div className={`w-full ${sizeClasses[size]} ${alignClasses[align]}`}>
      {src ? (
        ...
        <div
          className={`relative w-full ${aspectRatioClasses[aspectRatio]} overflow-hidden rounded-2xl bg-linear-to-br from-slate-100 to-slate-200 border border-slate-300 shadow-md`}
        >
